...
def main():
    df = load_excel_safe(settings.MASTER_EXCEL, settings.SHEET_NAME)
    ...
    for i, idx in enumerate(indices):
        ...
        filepath = str(settings.ANALYSIS_DIR / filename)
    ...
    df.to_excel(str(settings.MASTER_EXCEL), index=False)
